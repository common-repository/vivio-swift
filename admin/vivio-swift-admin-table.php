...
class Vivio_Swift_List_Table 
{
	...
	function ajax_user_can() {
		die( 'function Vivio_Swift_List_Table::ajax_user_can() must be over-ridden in a sub-class.' );
	}

	/**
	 * Prepares the list of items for displaying.
	 * @uses Vivio_Swift_List_Table::set_pagination_args()
	 *
	 * @since 3.1.0
	 * @access public
	 * @abstract
	...
	function prepare_items() {
		die( 'function Vivio_Swift_List_Table::prepare_items() must be over-ridden in a sub-class.' );
	}
...
<?php
	...
	function get_columns() {
		die( 'function Vivio_Swift_List_Table::get_columns() must be over-ridden in a sub-class.' );
	}
